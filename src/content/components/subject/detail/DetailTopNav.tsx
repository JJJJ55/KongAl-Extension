...
export const DetailTopNav = ({ title, teacher, onClick, onGet }: DetailTopNavProps) => {
  return (
    <header
      className="flex flex-row items-center p-5 transition-colors duration-500 bg-white dark:bg-dark12 rounded-2xl"
    ...
    >
      ...
      <X size={24} onClick={onClick} className="cursor-pointer flex-1/12 dark:text-white" />
    </header>
  )
}
